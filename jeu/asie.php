...
<html>
	  <head>
		  ...
		  <title> C&F | Continent d'Asie </title>
	...
	<header class="masthead">
                    <h2 class="section-heading text-uppercase"> Vous avez choisie le contient D'Asie </h2>
						...
						<div class="img-responsive" id="map" style="width: 1100px; height: 700px;  margin-top: 7%; border-radius: 70%" ></div>
    ...
    <script>
            ...
            center: [52.54177512916115,96.55566965889052],
            minZoom: 2,
            maxZoom: 6,
            zoom: 2.5,
            maxBounds: bornes
