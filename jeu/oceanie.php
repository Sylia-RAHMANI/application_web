...
<html>
	  <head>
		  ...
		  <title> C&F | Continent d'Océanie </title>
	...
	<header class="masthead">
                    <h2 class="section-heading text-uppercase"> Vous avez choisie le contient D'Océanie </h2>
							...
							<h2 id ="qst" class="text-center"> Quel pays représente ce drapeau ? <h2>
						...
						<div class="img-responsive" id="map" style="width: 1000px; height: 600px;  margin-top: 7%; border-radius: 70%" ></div>
    ...
    <script>
            ...
            center: [-24.96123662715419	,129.71841650158692],
            minZoom: 2,
            maxZoom: 6,
            zoom: 4,
            maxBounds: bornes
			...
			info.update = function (prop) {
				this._div.innerHTML = "<h3> Bien joué !!! </h3>" +
					...
					"<center><img class='img-responsive' width: 800px; height: 400px;  margin-top: 7%; border-radius: 70% src='"+<?php echo json_encode($pic); ?>+"'></center>";
			}; info.addTo(map);
			}
			}
